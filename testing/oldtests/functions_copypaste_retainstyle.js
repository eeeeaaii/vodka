...
*/
// test: functions_copypaste_retainstyle
/*
Makes sure that when you copy and paste something, it retains whatever css styles have been set.
*/

	// |Shift|~|a|p|p|l|y|-|s|t|y|l|e|-|t|o|Shift|$|Shift|Enter|f|o|n|t|-|s|t|y|l|e|Shift|:|i|t|a|l|i|c|;|Tab|Enter|Shift|(|w|o|r|d|Shift|Tab|Tab|Shift|Enter|Meta|c|v|v
