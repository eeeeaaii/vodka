...
// test: functions_syscalls_applystyleto
/*
Just tests the basic ability to set the style on something using apply-style-to. no error checking yet
*/

	// |Shift|~|a|p|p|l|y|-|s|t|y|l|e|-|t|o|Tab|Shift|$|Shift|Enter|f|o|n|t|-|w|e|i|g|h|t|Shift|:|b|o|l|d|;|Tab|Enter|Shift|(|Shift|H|e|l|l|o|Shift|Tab|Tab|Shift|Enter
