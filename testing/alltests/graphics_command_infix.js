...
*/
//endgnumessage//
//testname// graphics_command_infix
//startdescription//
/*
verifies that having spaces in command names displays correctly with different number of args
*/
//enddescription//
//testspec// |Shift|~|a| |a|Enter|ArrowRight|Shift|~|a| |a| | | |a|Enter|ArrowRight|Shift|Shift|~|a| |a| | |a| |a| |Enter|Shift|#|Shift|#|#|#|#|Shift|Tab|Shift|~| |a| | |a|Enter|Shift|#|#|#|#|#|#|#|Enter
//starttest//
