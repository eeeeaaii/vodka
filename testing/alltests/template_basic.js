...
//startdescription//
/*
tests basic templating 1. creates a vector template with two nonzero fields called x and y and an instance function (i.e. with 'self' bound) that calculates the magnitude 2. merges it 3. instantiates it 4. calls the magnitude function on the instance to verify that self pointer is bound etc.
*/
//enddescription//
//testspec// |Shift|~|t|e|m|p|l|a|t|e|Shift|^|`|Shift|V|e|c|t|o|r|Enter|Shift|)|Tab|Shift|%|1|2|`|x|Enter|Shift|%|2|4|`|y|Enter|Shift|&|Shift|%|Enter|Shift| |`|Shift|:|m|a|g|n|i|t|u|d|e|Enter|Tab|Shift|~|s|q|u|a|r|e|Control| |Tab|Shift|~|Shift|+|Tab|Shift|~|p|o|w|e|r|Shift|@|s|e|l|f|`|x|Enter|Shift|%|2|Shift|Tab|Shift|~|p|o|w|e|r|Shift|@|s|e|l|f|`|y|Enter|Shift|%|2|Shift|Tab|Tab|Tab|Tab|Tab|Tab|Meta|c|v|Enter|Shift|~|i|n|s|Backspace|Backspace|Backspace|b|i|n|d|Shift|@|v|Shift|~|i|n|s|t|a|n|t|i|a|t|e|Shift|~|m|e|r|g|e|Shift|^|`|Shift|V|e|c|t|o|r|Enter|Shift|Tab|Tab|Tab|Meta|c|v|Enter|Shift|~|Tab|Shift|@|v|`|m|a|g|n|i|t|u|d|e|Enter|Shift|Tab|Enter
//starttest//
