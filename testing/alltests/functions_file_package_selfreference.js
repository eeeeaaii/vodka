...
*/
//endgnumessage//
//testname// functions_file_package_selfreference
//startdescription//
/*
tests that in a package definition you can refer to other members of the package that have already been bound
*/
//enddescription//
//testspec// |Shift|~|p|a|c|k|a|e|Backspace|g|e|Shift| |Shift|@|f|o|o|Enter|Shift|~|b|i|n|d|Shift|@|a|Shift|#|1|0|0|Shift|Tab|Shift|~|b|i|n|d|Shift|@|b|Shift|@|a|Shift|Tab|Tab|Enter|Shift|@|a|Enter|Enter|Shift|@|f|o|o|Shift|:|a|Enter|Enter|Shift|@|f|o|o|Shift|:|b|Enter|Enter|Shift|~|b|i|n|d|i|n|g|s|Enter|Enter
//starttest//
