...
*/
//endgnumessage//
//testname// functions_file_save_withstring
//startdescription//
/*
tests saving with a string instead of symbol
*/
//enddescription//
//testspec// |Shift|~|s|a|v|e|Shift|$|t|Tab|Enter|Shift|{|a|p|p|l|e|s|Shift|Tab|Tab|Tab|Shift|Tab|Shift|~|l|o|a|d|Shift|$|t|Tab|Enter|Shift|Tab|Enter|Shift|~|l|o|a|d|Shift|@|t|Shift|Tab|Enter
//starttest//
