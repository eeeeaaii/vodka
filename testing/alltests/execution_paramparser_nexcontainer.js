...
*/
//endgnumessage//
//testname// execution_paramparser_nexcontainer
//startdescription//
/*
test nexcontainer paramparser (passing in, returning, failed and successful cases)
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|f|1|Shift|&| |a|Shift|(|)|Enter|Tab|Shift|@|a|Shift|Tab|Tab|~|b|i|n|d|Shift|@|f|2|Shift|&|Shift|(|)|Enter|Tab|Shift|(|Shift|Tab|Tab|Shift|~|b|i|n|d|Shift|@|f|3|Shift|&|Shift|(|)|Enter|Tab|Shift|$|Shift|Tab|Tab|Shift|~|f|1|Tab|Shift|(|Shift|Tab|Shift|~|f|1|Shift|$|Shift|Tab|Shift|~|f|2|ArrowRight|Shift|~|f|3|ArrowLeft|ArrowLeft|ArrowLeft|ArrowLeft|ArrowLeft|ArrowLeft|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter
//starttest//
