...
*/
//endgnumessage//
//testname// functions_contract_musthavecontentstaggedlike
//startdescription//
/*
verifies tags AND contents identical, tests with various wrong ones and a right one
*/
//enddescription//
//testspec// |Shift|~|m|u|s|i|t|Backspace|Backspace|t|-|h|a|v|e|-|c|o|n|t|e|n|t|s|-|t|a|g|g|e|d|-|l|i|k|e|Shift|^|`|Shift|I|n|t|2|d|Shift|V|e|c|Shift|D|a|t|a|Enter|Shift|)|Shift|#|`|x|Enter|Shift|#|`|y|Enter|Shift|Tab|Tab|Meta|c|v|Enter|`|Shift|I|n|t|2|d|Shift|V|e|c|Shift|D|a|t|a|Enter|Shift|)|Shift|#|#|Shift|Tab|`|Shift|I|n|t|2|d|Shift|V|e|c|Shift|D|a|t|a|Enter|Shift|)|Shift|%|`|s|Backspace|x|Enter|Shift|%|`|y|Enter|Shift|Tab|`|Shift|I|n|t|2|d|Shift|V|e|c|Shift|D|a|t|a|Enter|Shift|)|Shift|#|`|x|Enter|Shift|#|x|Backspace|`|z|Enter|Shift|Tab|`|Shift|I|n|t|2|d|Shift|V|e|c|Shift|D|a|t|a|Enter|Shift|)|Shift|#|`|x|Enter|Shift|#|`|y|Enter|Shift|#|`|z|Enter|Shift|Tab|`|Shift|I|n|t|2|d|Shift|V|e|c|Shift|D|a|t|a|Enter
//starttest//
