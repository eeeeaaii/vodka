...
*/
//endgnumessage//
//testname// execution_org_dereference
//startdescription//
/*
tests basic dereferencing of orgs, but not any class features (this is just orgs as structs)
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Shift|)|Tab|Shift|%|3|.|1|4|`|p|i|Enter|Shift|&| |a| |b|Enter|Shift| |Tab|Shift|~|Shift|+|Shift|@|a|Shift|@|b|Shift|Tab|Shift|Tab|`|a|d|d|Enter|Shift|Tab|Tab|Shift|Enter|Shift|~|Tab|Shift|@|a|`|a|d|d|Enter|Shift|#|3|Shift|#|4|Shift|Tab|Shift|~|Backspace|Shift|@|a|`|p|i|Enter|ArrowLeft|Enter|ArrowRight|Enter
//starttest//
