...
*/
//endgnumessage//
//testname// execution_expectation_set_cannot
//startdescription//
/*
tests the two cases where you cannot set an expectation: when it's been fulfilled, and when it's been activated.
*/
//enddescription//
//testspec// |Shift|~|s|e|t|-|d|e|l|a|y|Tab|Shift|#|1|0|ArrowLeft|Shift|~|f|f|Tab|Shift|~|f|f|-|w|t|Backspace|i|t|h|Tab|Shift|*|Tab|Shift|#|Shift|Tab|Shift|&| |a|Enter|Shift| |Tab|Shift|~|Shift|+|Tab|Shift|@|a|Shift|#|1|Shift|Tab|Tab|Tab|Tab|Tab|Shift|~|s|e|t|-|d|e|l|a|y|Tab|Shift|#|1|0|ArrowLeft|Shift|~|f|f|Tab|Shift|~|s|e|t|-|d|e|l|a|y|Tab|Shift|*|Tab|Shift|#|Shift|Tab|Shift|#|1|0|0|0|Shift|Tab|Tab|Tab|Enter|ArrowLeft|Enter
//starttest//
