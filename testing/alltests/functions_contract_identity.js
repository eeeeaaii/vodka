...
*/
//endgnumessage//
//testname// functions_contract_identity
//startdescription//
/*
tests identity contract
*/
//enddescription//
//testspec// |Shift|~|c|e|r|t|i|f|y| |s|a|t|i|s|f|i|e|s|Enter|Shift|$|a|Tab|Enter|Shift|~|b|i|n|d|Shift|@|a|Enter|Shift|(|Shift|$|a|p|p|l|e|s|Tab|Enter|Shift|Tab|Enter|Shift|Tab|Enter|Shift|Alt|`|i|d|e|n|t|i|f|y|Backspace|t|Backspace|Backspace|t|y|-|c|o|n|t|r|a|c|t|Enter|Shift|Tab|Enter|Shift|#|Enter|`|a|Enter|Shift|@|a|Enter|Enter|`|a|Enter
//starttest//
