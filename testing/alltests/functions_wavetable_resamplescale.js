...
*/
//endgnumessage//
//testname// functions_wavetable_resamplescale
//startdescription//
/*
tests the resample-scale builtin
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|w|a|v|Enter|s|i|n|e|w|a|v|e|Enter|Shift|Tab|Enter|Shift|~|r|e|s|a|m|p|l|e|0|Backspace|-|s|c|a|l|e|Enter|Shift|@|w|a|v|Enter|Shift|#|0|Shift|Tab|Enter|Shift|~|r|e|s|a|m|p|l|e|-|s|c|a|l|e|Enter|Shift|@|w|a|v|Enter|Shift|#|7|Shift|Tab|Enter|Shift|~|r|e|s|a|m|p|l|e|-|s|c|a|l|e|Enter|Shift|@|w|a|v|Enter|Shift|#|5|-|Shift|Tab|Enter
//starttest//
