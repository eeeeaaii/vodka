...
*/
//endgnumessage//
//testname//  functions_environment_bind_tointeger
//startdescription//
/*
Binds (non-uniquely) the number 3 to the symbol 'pi' then evaluates the symbol 'pi' 3 times to verify that simple binding works and that you get multiple copies when you non-uniquely bind
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Tab|Shift|@|a|Backspace|p|i|Shift|#|3|Shift|Tab|Shift|Enter|Shift|@|p|i|Shift|Enter|Shift|@|p|i|Shift|Enter|Shift|@|p|i|Shift|Enter
//starttest//
