...
*/
//endgnumessage//
//testname// functions_wavetable_setdefaulttimebase
//startdescription//
/*
sets the default timebase then creates a sinewave to verify that it defaults to that timebase that was set.
*/
//enddescription//
//testspec// |s|e|t|-|d|e|f|a|u|l|t|-|t|i|m|e|b|a|s|e|Enter|Shift|#|`|n|n|Enter|Shift|Tab|Enter|s|i|m|e|w|Backspace|Backspace|Backspace|n|e|w|a|v|e|Enter|Enter
//starttest//
