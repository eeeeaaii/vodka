...
*/
//endgnumessage//
//testname// functions_make_makecommand
//startdescription//
/*
tests "make-command", which actually treats symbols specially/correctly
*/
//enddescription//
//testspec// |Shift|~|m|a|k|e|-|c|o|m|m|a|n|d|ArrowRight|Shift|~|m|a|k|e|-|c|o|m|m|a|n|d|Tab|Shift|~|q|u|o|t|e|Tab|Shift|@|f|i|r|s|t|Shift|Tab|ArrowRight|Shift|(|Tab|Shift|#|#|#|Shift|Tab|Shift|Tab|Shift|~|m|a|k|e|-|c|o|m|m|a|n|d|Tab|Shift|&| |a| |b|Enter|Shift| |Tab|Shift|~|Shift|+|Shift|@|a|Shift|@|b|Shift|Tab|Tab|Shift|#|#|Shift|Tab|ArrowLeft|ArrowLeft|Enter|ArrowRight|Enter|ArrowRight|Enter
//starttest//
