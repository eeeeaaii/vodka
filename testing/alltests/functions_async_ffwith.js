...
//startdescription//
/*
tests ff-with with no accompanying delay - also incidentally tests the fact that if an expectation that hasn't been set is activated, it will directly invoke ff-with.
*/
//enddescription//
//testspec// |Shift|~|f|f|-|w|i|t|h|Tab|Shift|*|Tab|Shift|#|3|Shift|Tab|Shift|&| |n|Enter|Shift|~|Shift|+|Shift|@|n|Shift|#|1|0|0|Shift|Tab|Tab|Tab|Enter
//starttest//
