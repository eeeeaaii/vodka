...
*/
//endgnumessage//
//testname//  functions_string_cat
//startdescription//
/*
testing string-cat with one arg, no args, two args, three args.
*/
//enddescription//
//testspec// |Shift|~|s|t|r|i|n|g|-|c|a|t|Shift|$|Shift|Enter|h|e|l|l|o|Tab|Enter|Shift|Tab|Shift|~|s|t|r|i|n|g|-|c|a|t|ArrowRight|Shift|~|s|t|r|i|n|g|-|c|a|t|Shift|$|Shift|Enter|h|e|l|Tab|Enter|Shift|$|Shift|Enter|l|o|0|Backspace|Tab|Enter|Shift|Tab|Shift|~|s|t|r|i|n|g|=|Backspace|-|c|a|t|Shift|$|Shift|Enter|h|Tab|Enter|Shift|$|Shift|Enter|e|l|Tab|Enter|Shift|$|Shift|Enter|l|o|Tab|Enter|Shift|Tab|ArrowUp|ArrowUp|ArrowUp|Shift|Enter|ArrowDown|Shift|Enter|ArrowDown|Shift|Enter|ArrowDown|Shift|Enter
//starttest//
