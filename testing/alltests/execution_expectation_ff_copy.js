...
*/
//endgnumessage//
//testname// execution_expectation_ff_copy
//startdescription//
/*
makes sure you can copy an exp and it can be fulfilled the same way
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Shift|~|c|o|p|y|Tab|Shift|~|s|e|t|-|i|n|t|e|r|Backspace|Backspace|Backspace|Backspace|Backspace|d|e|l|a|y|Tab|Shift|~|f|f|-|w|i|t|h|Tab|Shift|*|Tab|Shift|#|1|0|Shift|Tab|Shift|#|1|0|Backspace|Backspace|Backspace|Shift|&| |n|Enter|Shift| |Tab|Shift|~|Shift|+|Tab|Shift|@|n|Shift|#|1|Shift|Tab|Tab|Tab|Shift|#|1|0|0|0|Shift|Tab|Tab|Tab|Enter|Shift|~|f|f|Tab|Shift|@|a|Shift|Tab|Enter
//starttest//
