...
*/
//endgnumessage//
//testname// actions_funnel_doc_specialchars
//startdescription//
/*
tests that characters like !, @, etc can be typed normally in a doc context (new behavior)
*/
//enddescription//
//testspec// |Shift|{|Shift|A|Shift|!|p|Shift|@|a|Shift|#|k|Shift|$|k|Shift|%|k|Shift|^|k|Shift|&|k|Shift|*|s|Shift|(|h|Shift|)
//starttest//
