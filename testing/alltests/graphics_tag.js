...
*/
//endgnumessage//
//testname// graphics_tag
//startdescription//
/*
test for graphics of tag
*/
//enddescription//
//testspec// |Shift|$|h|e|l|l|o|Tab|Enter|`|a|ArrowRight|b|ArrowRight|c|ArrowRight|s|d|ArrowRight|f|ArrowRight|s|d|ArrowRight|s|s|f|ArrowRight|f|d|f|s|ArrowRight|s|d|f|s|d|f|ArrowRight|d|d|d|Enter|Shift|$|a|Tab|Enter|`|a|Enter|Shift|!|Enter|`|a|ArrowRight|b|ArrowRight|c|ArrowRight|d|Enter|Shift|@|Enter|`|a|ArrowRight|a|ArrowRight|a|ArrowRight|b|ArrowRight|c|ArrowRight|d|ArrowRight|e|Shift|Enter|Shift|#|Enter|`|a|Shift|b|Shift|c|Shift|ArrowRight|d|ArrowRight|f|Enter|4|Shift|Backspace|Shift|%|Enter|`|f|ArrowRight|g|ArrowRight|d|ArrowRight|h|ArrowRight|s|Enter|Shift|^|a|Enter|`|m|e|r|o|Enter|ArrowRight|Shift|^|Shift| |`|a|p|e|r|s|k|l|Enter|ArrowRight|Shift|~|Enter|`|a|s|d|f|Enter|Shift|~|Shift| |`|d|f|k|Enter|ArrowRight|Shift|&|n|n|n|n|Enter|`|a|a|a|Enter|a|ArrowRight|Shift|Backspace|`|d|ArrowRight|f|Enter|ArrowRight|Meta|c|v|Shift| |Shift|Tab|Shift|*|t|k|s|d|f|Enter|`|a|a|a|Enter|Meta|c|v|Shift| |Shift|Tab|Shift|(|Shift|#|#|#|Enter|`|a|p|p|Backspace|Backspace|Backspace|Enter|Shift|Tab|`|a|p|p|Enter|Meta|c|v|Shift| |Meta|c|v|Shift| 
//starttest//
