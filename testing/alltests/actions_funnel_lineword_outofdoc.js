...
*/
//endgnumessage//
//testname// actions_funnel_lineword_outofdoc
//startdescription//
/*
verifies that typing letters and symbols inside a line or inside a word that are NOT in a doc does the right thing, in particular that if a word is not in a line and you type a nonletter, it just inserts it in the word instead of making a separator.
*/
//enddescription//
//testspec// |Shift|~|[|a|p|p|l|e|s|Shift|#|a|n|d|Shift|#|b|a|n|a|n|a|s|Shift|Tab|Tab|Shift|<|a|p|p|l|e|s|Shift|#|a|n|d|Shift|#|b|a|n|a|n|a|s|Shift|Tab|Tab
//starttest//
