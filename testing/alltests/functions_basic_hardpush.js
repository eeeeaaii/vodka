...
*/
//endgnumessage//
//testname// functions_basic_hardpush
//startdescription//
/*
tests hard push
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Shift|(|Enter|Shift|Tab|Enter|Enter|ArrowRight|Shift|~|h|a|r|d|-|p|u|s|h|Control| |Shift|#|3|Shift|@|a|Enter|Shift|Tab|Enter
//starttest//
