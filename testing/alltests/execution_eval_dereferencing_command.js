...
*/
//endgnumessage//
//testname// execution_eval_dereferencing_command
//startdescription//
/*
tests that you can deference in a command (a.b) -- also tests that a command text that starts with a dot dereferences the first argument.
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|t|Enter|Shift|(|Shift|&|n|Enter|Shift|~|Shift|+|Shift|@|n|Shift|@|n|Shift|Tab|Shift|Tab|Enter|`|d|o|u|l|Backspace|b|l|e|Enter|Shift|(|`|m|o|r|e|Enter|Shift|&|n|Enter|Shift|~|Shift|+|Enter|Shift|#|3|Backspace|n|Shift|Backspace|Shift|Backspace|Shift|@|n|Shift|@|n|Shift|@|n|Shift|Tab|Tab|Enter|`|t|r|i|p|l|e|Enter|Shift|Tab|Tab|Tab|Shift|Enter|Shift|~|t|.|d|o|u|b|l|e|Shift|#|3|Shift|Tab|Enter|Shift|~|t|.|m|o|r|e|.|t|r|i|p|l|e|Enter|Shift|#|3|Shift|Tab|Enter|ArrowLeft|ArrowLeft|ArrowLeft|Tab|ArrowRight|ArrowRight|Meta|c|ArrowLeft|ArrowLeft|Alt|Shift|`|Enter|Tab|ArrowRight|ArrowRight|Shift|#|3|Shift|Tab|Backspace|.|d|o|u|b|l|e|Enter|Meta|c|v|Enter|ArrowLeft|ArrowLeft|Backspace|Backspace|Backspace|Backspace|Backspace|Backspace|Backspace|m|o|r|e|.|t|r|i|p|l|e|Enter|Enter
//starttest//
