...
*/
//endgnumessage//
//testname// execution_expectation_set_again
//startdescription//
/*
tests that if you call set-* on an expectation the new set will override the old one
*/
//enddescription//
//testspec// |Shift|~|s|e|t|-|i|m|m|e|d|i|a|t|e|Tab|Shift|~|s|e|t|-|d|e|l|a|y|Tab|Shift|#|3|0|0|0|0|ArrowLeft|Shift|~|f|f|-|w|i|t|h|Tab|Shift|*|Tab|Shift|#|Shift|Tab|ArrowRight|Shift|~|Backspace|Shift|&| |n|Enter|Shift| |Tab|Shift|~|Shift|+|Tab|Shift|@|n|Shift|#|1|Shift|Tab|Tab|Tab|Tab|Tab|Enter
//starttest//
