...
*/
//endgnumessage//
//testname// execution_eval_deferencing_symbol
//startdescription//
/*
tests that you can do a.b in a symbol and it dereferences
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Enter|Shift|(|Shift|#|3|Enter|`|t|h|r|e|e|Enter|Shift|(|`|m|o|r|e|Enter|Shift|#|6|Enter|`|s|i|z|Backspace|x|Enter|Shift|Tab|Tab|Tab|Shift|Enter|Shift|@|a|.|t|h|r|e|e|Enter|Enter|Shift|@|a|.|m|o|r|e|.|s|i|x|Enter|Enter
//starttest//
