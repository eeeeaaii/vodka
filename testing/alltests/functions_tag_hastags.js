...
*/
//endgnumessage//
//testname// functions_tag_hastags
//startdescription//
/*
tests has-tags test
*/
//enddescription//
//testspec// |Shift|~|h|a|s|-|t|a|g|s|Enter|Shift|$|a|p|p|l|e|s|Tab|Enter|`|j|a|c|k|s|Enter|Shift|Tab|ArrowLeft|Backspace|Backspace|Control|Backspace|Backspace|Backspace|Backspace|Backspace|Backspace|a|s|Control| |Enter|ArrowRight|Tab|ArrowRight|ArrowRight|Shift|$|j|a|c|k|s|Tab|Enter|Shift|Tab|Enter|Shift|~|h|a|s|-|t|a|Control| |Enter|Shift|$|a|p|p|l|e|s|Tab|Enter|Shift|$|j|a|c|k|s|Tab|Enter|Shift|Tab|Enter
//starttest//
