...
*/
//endgnumessage//
//testname// functions_wavetable_wavecalc
//startdescription//
/*
test wavecalc with just a function that squares the value
*/
//enddescription//
//testspec// |w|a|v|e|c|a|l|c|Enter|s|a|w|w|a|v|e|Enter|ArrowRight|Shift|&|n|Shift| |Shift|~|Shift|*|Enter|Shift|@|n|Shift|@|n|Shift|Tab|Tab|Tab|Enter
//starttest//
