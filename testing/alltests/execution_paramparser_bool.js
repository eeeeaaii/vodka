...
*/
//endgnumessage//
//testname// execution_paramparser_bool
//startdescription//
/*
tests passing in bool, returning a bool, both failed and successful cases, including passing through a passed-in bool
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|f|1|Shift|&| |a|Shift|!|Enter|Tab|Shift|@|a|Shift|Tab|Tab|Shift|~|b|i|n|d|Shift|@|f|2|Shift|&|Shift|!|Enter|Tab|Shift|#|Shift|Tab|Tab|Shift|~|b|i|n|d|Shift|@|f|3|Shift|&|Shift|!|Enter|Tab|Shift|!|Shift|Tab|Tab|Shift|~|b|i|n|d|Shift|@|f|4|Shift|&|Shift|!| |a|Shift|!|Enter|Tab|Shift|~|n|o|t|Shift|@|a|Shift|Tab|Tab|Tab|ArrowUp|ArrowUp|ArrowUp|Shift|Enter|ArrowDown|Shift|Enter|ArrowDown|Shift|Enter|ArrowDown|Shift|Enter|ArrowRight|Shift|~|a|Backspace|f|1|Shift|#|Shift|Tab|Shift|~|f|2|Tab|Shift|!|Shift|Tab|Shift|~|f|3|Backspace|2|ArrowLeft|Backspace|1|ArrowRight|ArrowRight|Shift|~|f|3|ArrowRight|Shift|~|f|4|Tab|Shift|!|Shift|Tab|ArrowLeft|ArrowLeft|ArrowLeft|ArrowLeft|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter
//starttest//
