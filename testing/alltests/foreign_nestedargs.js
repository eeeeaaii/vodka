...
*/
//endgnumessage//
//testname// foreign_nestedargs
//startdescription//
/*
verifies that if you try to pass too-deeply-nested args into a foreign closure function it will throw error
*/
//enddescription//
//testspec// |Shift|Enter|~|b|i|n|d|Shift|@|r|Shift|(|Tab|3|Shift|Tab|Tab|Enter|Shift|~|c|r|a|m|Shift|@|r|Shift|@|r|Shift|Tab|Enter|ArrowLeft|Shift|~|b|i|n|d|Shift|@|c|Shift|~|i|n|s|t|a|n|t|i|a|t|e|Shift|@|c|`|Backspace|Enter|Backspace|Backspace|Shift|^|`|Shift|C|a|n|v|a|s|Enter|Shift|#|3|0|Shift|#|3|0|Shift|Tab|Tab|Enter|Shift|~|c|Backspace|Shift|@|c|`|f|i|l|l|-|b|a|c|k|g|r|o|u|n|d|Enter|Shift|@|r|Shift|Tab|Enter
//starttest//
