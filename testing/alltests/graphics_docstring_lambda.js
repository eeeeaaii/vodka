...
*/
//endgnumessage//
//testname// graphics_docstring_lambda
//startdescription//
/*
tests rendering of user-input doc strings in lambda (tests both the doc form and the estring form)
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Shift|&|Shift| |Shift|{|Shift|F|i|r|s|t| |t|y|p|e| |o|f|Enter|d|o|c| |s|t|r|i|n|g|Shift|Tab|Tab|Tab|Shift|~|Shift|+|Shift|#|3|Shift|#|3|Shift|Tab|Tab|Tab|Enter|Shift|~|b|i|n|d|Shift|@|b|Shift|&|Shift| |Shift|$|Shift|Enter|e|Backspace|s|e|c|o|n|d| |t|y|p|e| |o|f| |d|o|c| |s|t|r|i|n|g|.|Tab|Enter|Shift|~|Shift|+|Shift|#|3|Shift|#|3|Shift|Tab|Tab|Tab|Enter|ArrowLeft|Enter|ArrowRight|Enter
//starttest//
