...
*/
//endgnumessage//
//testname// functions_string_joinon
//startdescription//
/*
string join on
*/
//enddescription//
//testspec// |Shift|~|s|t|r|i|n|g|-|j|o|i|n|-|o|n|Enter|Shift|(|Shift|$|a|Tab|Enter|Shift|$|b|Tab|Enter|Shift|$|c|Tab|Enter|Shift|Tab|Shift|$|;|Tab|Enter|Shift|Tab|Enter
//starttest//
