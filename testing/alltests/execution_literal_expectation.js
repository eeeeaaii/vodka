...
*/
//endgnumessage//
//testname// execution_literal_expectation
//startdescription//
/*
tests that if you evaluate an expectation literal, it will copy if the expectation is empty, not copy if it has children
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|g|e|t|e|x|p|1|Shift|&|Enter|Tab|Shift|*|Tab|Shift|#|Shift|Tab|Tab|Shift|Tab|Shift|~|b|i|n|d|Shift|@|g|e|t|e|x|p|2|Shift|&|Enter|Tab|Shift|*|Shift|Tab|Tab|ArrowLeft|Shift|Enter|ArrowRight|Shift|Enter|Shift|~|g|e|t|e|x|p|1|Enter|ArrowRight|Shift|~|g|e|t|e|x|p|2|Enter
//starttest//
