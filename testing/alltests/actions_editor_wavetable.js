...
*/
//endgnumessage//
//testname// actions_editor_wavetable
//startdescription//
/*
simple wavetable editor test
*/
//enddescription//
//testspec// |Shift|_|Backspace|v|v|Enter|Shift|~|s|p|l|i|t|Enter|ArrowLeft|ArrowLeft|Meta|c|ArrowRight|ArrowRight|Tab|Meta|v|Shift|Tab|Enter
//starttest//
...
testactions.push({type:'click',x:'30',y:'61'});
testactions.push({type:'keydown',code:'KeyV'});
testactions.push({type:'keyup',code:'KeyV'});
testactions.push({type:'click',x:'105',y:'62'});
testactions.push({type:'click',x:'183',y:'65'});
testactions.push({type:'keydown',code:'KeyV'});
testactions.push({type:'keyup',code:'KeyV'});
