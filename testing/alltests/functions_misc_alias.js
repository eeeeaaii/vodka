...
*/
//endgnumessage//
//testname// functions_misc_alias
//startdescription//
/*
verifies you can alias commands (first is aliased to car)
*/
//enddescription//
//testspec// |Shift|~|c|a|r|Shift|(|a|b|c|Shift|Tab|Tab|Enter|Shift|~|f|i|r|s|t|Shift|(|a|b|c|Shift|Tab|Tab|Enter
//starttest//
