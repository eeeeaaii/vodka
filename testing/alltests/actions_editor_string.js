...
*/
//endgnumessage//
//testname// actions_editor_string
//startdescription//
/*
A more basic test of the string editor that doesn't involve escaped  characters.
*/
//enddescription//
//testspec// |Shift|$|a|Enter|b|Enter|c|Enter|d|Enter|Tab|Enter|Shift|$|t|y|p|i|n|g| |v|e|r|y| |l|o|n|g| |t|e|x|t| |t|h|a|t| |w|r|a|p|s| |o|v|e|r|Tab|Enter|Shift|$|c|l|i|c|k|i|n|g| |d|o|n|e|Shift|$|d|a|Tab|Enter|Backspace|Backspace|Backspace|Tab|Enter
//starttest//
...
testactions.push({type:'keydown',code:'KeyE'});
testactions.push({type:'keyup',code:'KeyE'});
testactions.push({type:'click',x:'295',y:'155'});
testactions.push({type:'keydown',code:'ShiftRight'});
testactions.push({type:'keydown',code:'Digit4'});
testactions.push({type:'keyup',code:'Digit4'});
testactions.push({type:'keyup',code:'ShiftRight'});
