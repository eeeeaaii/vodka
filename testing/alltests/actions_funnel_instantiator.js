...
*/
//endgnumessage//
//testname// actions_funnel_instantiator
//startdescription//
/*
tests that instantiators exist and work
*/
//enddescription//
//testspec// |Shift|~|t|e|m|p|l|a|t|e|Shift|@|Shift|T|e|s|t|Shift|(|Shift|#|3|Enter|`|p|i|Enter|Shift|Tab|Tab|Enter|Shift|^|Shift|T|e|s|t|Enter|Enter
//starttest//
