...
*/
//endgnumessage//
//testname// execution_expectation_ffwith_again
//startdescription//
/*
tests that if you call ff-with on an exp, the new ffwith will be used not the old one
*/
//enddescription//
//testspec// |Shift|~|f|f|-|w|i|t|h|Tab|Shift|&| |n|Enter|Shift| |Tab|Shift|~|Shift|+|Tab|Shift|@|n|Shift|#|1|0|Shift|Tab|Tab|ArrowLeft|Shift|~|f|f|-|w|i|t|h|Tab|Shift|&| |n|2|Enter|Shift| |Tab|Shift|~|Shift|+|Tab|Shift|@|n|2|Shift|#|1|Shift|Tab|Tab|ArrowLeft|Shift|*|Tab|Shift|#|Shift|Tab|Tab|Tab|Enter
//starttest//
