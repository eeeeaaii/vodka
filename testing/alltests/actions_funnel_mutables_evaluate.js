...
*/
//endgnumessage//
//testname// actions_funnel_mutables_evaluate
//startdescription//
/*
tests that when immutable objects are evaluated they are made immutable
*/
//enddescription//
//testspec// |Shift|!|#|$|Tab|Enter|Shift|%|Shift|(|Shift|!|#|$|Tab|Enter|Shift|%|Shift|{|a|p|p|l|e|s|Shift|CapsLock|Shift|Tab|Tab|Tab|Tab|ArrowLeft|ArrowLeft|ArrowLeft|ArrowLeft|ArrowLeft|ArrowLeft|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Shift|Shift|Enter
//starttest//
