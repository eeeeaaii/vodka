...
*/
//endgnumessage//
//testname// actions_funnel_word_insertafterbefore
//startdescription//
/*
verifies that if a word is selected, and the insertion point is before or after the word instead of inside it, the context that determines what happens is based on the parent of the word. So if the parent of the word is a command, for example, typing "4" would result in inserting an integer as opposed to typing a letter object with the value 4.
*/
//enddescription//
//testspec// |Shift|~|a|Enter|Shift|<|Alt|ArrowRight|a|ArrowLeft|ArrowLeft|a|ArrowRight|ArrowRight|2|ArrowLeft|ArrowLeft|2|ArrowRight|Shift|#|ArrowLeft|ArrowLeft|Shift|#|ArrowRight|;|ArrowLeft|Alt|ArrowLeft|;
//starttest//
