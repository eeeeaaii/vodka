...
*/
//endgnumessage//
//testname//  saveload_preservevertical
//startdescription//
/*
tests saving and loading a set of random commands, with the goal of making sure that if you save something that's in vertical orientation, it's restored in vertical orientation
*/
//enddescription//
//testspec// |Shift|~|s|a|v|e|Shift|@|t|Shift|~|a|b|c|Shift| |Shift|~|d|e|f|Shift|#|Shift|#|Shift|Tab|Shift|~|g|h|i|Shift|Tab|Tab|Shift|Enter|Shift|~|l|o|a|d|Shift|@|t|Shift|Tab|Shift|Enter
//starttest//
