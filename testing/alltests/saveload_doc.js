...
*/
//endgnumessage//
//testname//  saveload_doc
//startdescription//
/*
basic saving and loading of a few nested doc objects.
*/
//enddescription//
//testspec// |Shift|~|s|a|v|e|Tab|Shift|@|t|Shift|{|Tab|Shift|{|{|{|Shift|Tab|Tab|Shift|Enter|Shift|~|l|o|a|d|Tab|Shift|@|t|Shift|Tab|Shift|Enter
//starttest//
