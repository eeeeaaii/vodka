...
*/
//endgnumessage//
//testname//  saveload_bool
//startdescription//
/*
standard test for saving and loading booleans -- both true and false, mixed with other data types
*/
//enddescription//
//testspec// |Shift|~|s|a|v|e|Tab|Shift|@|t|Shift|(|Tab|Shift|!|!|y|Shift|#|3|Shift|!|Shift|Tab|Tab|Shift|Enter|Shift|~|l|o|a|d|Tab|Shift|@|t|Shift|Tab|Shift|Enter
//starttest//
