...
*/
//endgnumessage//
//testname// functions_basic_hardtail
//startdescription//
/*
tests hard tail
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Enter|Shift|(|Shift|#|3|Shift|#|4|Shift|#|5|Enter|Shift|Tab|Tab|Enter|Enter|Shift|~|h|a|r|d|-|t|a|i|l|Shift|@|a|Shift|Tab|Enter
//starttest//
