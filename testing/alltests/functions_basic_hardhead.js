...
*/
//endgnumessage//
//testname// functions_basic_hardhead
//startdescription//
/*
tests hard head
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Enter|Shift|(|Shift|#|3|Shift|#|4|Enter|Shift|#|5|Enter|Shift|Tab|Tab|Enter|Enter|Shift|~|h|a|r|d|-|h|e|a|d|Enter|Shift|@|a|Shift|Tab|Enter
//starttest//
