...
*/
//endgnumessage//
//testname// actions_editor_lambda_cacheswhenempty
//startdescription//
/*
verifies that when you delete all the characters in the lambda param string it will still re-parse the args and remove any type info that was there before
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Shift|&|n|Shift|#|Enter|Shift|@|n|Enter|Shift|Tab|Tab|Shift|Enter|Shift|~|a|Enter|Shift|@|n|Enter|Shift|Backspace|Shift|#|Enter|Shift|Tab|Enter|ArrowLeft|ArrowLeft|Tab|ArrowRight|ArrowRight|Backspace|Backspace|Backspace|Enter|Shift|Tab|ArrowRight|a|Enter|Shift|#|Enter|Shift|Tab|Enter
//starttest//
