...
*/
//endgnumessage//
//testname//  functions_math_dividedby
//startdescription//
/*
complete test of division (including mixed float and int)
*/
//enddescription//
//testspec// |Shift|~|6|Backspace|/|Tab|Shift|#|6|Shift|#|3|Shift|Tab|Shift|~|/|Tab|Shift|#|6|Shift|%|1|.|1|Shift|Tab|Shift|~|/|Shift|#|Backspace|Tab|Shift|#|6|.|1|Backspace|Backspace|Backspace|Backspace|Tab|Shift|%|6|.|1|Shift|%|2|.|2|Shift|Tab|Shift|~|/|Shift|Tab|Shift|%|4|.|4|Shift|#|2|Shift|Tab|ArrowUp|ArrowUp|ArrowUp|Shift|Enter|ArrowDown|Shift|Enter|ArrowDown|Shift|Enter|ArrowDown|Shift|Enter
//starttest//
