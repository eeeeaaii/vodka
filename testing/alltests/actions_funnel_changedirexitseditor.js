...
*/
//endgnumessage//
//testname// actions_funnel_changedirexitseditor
//startdescription//
/*
Verifies that for container nexes that have editors (command, lambda, instantiator, and deferred command), changing the direction of the container while editing will exit the editor ... note this is explicitly verified by typing a letter right after changing direction -- if this behavior is broken the typed letter would be added to the contents of the container that was flipped
*/
//enddescription//
//testspec// |Shift|~|a|p|p|l|e|Shift| |a|Enter|Shift|Tab|Shift|^|a|p|p|l|e|Shift| |a|Enter|Shift|Tab|Shift|&|a|p|p|l|e|Shift| |a|Enter|Shift|Tab|Shift|*|a|p|p|l|e|Shift| |a|Enter
//starttest//
