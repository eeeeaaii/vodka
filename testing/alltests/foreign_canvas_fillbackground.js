...
*/
//endgnumessage//
//testname// foreign_canvas_fillbackground
//startdescription//
/*
verifies that fill bg works
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|c|Shift|~|i|n|s|t|a|n|t|i|a|t|e|Shift|^|`|Shift|C|a|n|v|a|s|Enter|Shift|#|3|0|0|Shift|#|3|0|0|Shift|Tab|Tab|Enter|Enter|Shift|~|Shift|@|c|`|f|i|l|l|-|b|a|c|k|g|r|o|u|n|d|Enter|Shift|(|Shift|#|2|0|0|Shift|#|1|0|0|Backspace|Backspace|Backspace|Backspace|Backspace|Backspace|Backspace|Backspace|Tab|Shift|#|1|0|0|Shift|#|2|0|0|Shift|#|Shift|Tab|Tab|Enter
//starttest//
