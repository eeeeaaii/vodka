...
*/
//endgnumessage//
//testname// functions_basic_begin
//startdescription//
/*
test begin (modifies some global state to verify they all execute)
*/
//enddescription//
//testspec// |Shift|~|b|e|g|i|n|Shift| |Shift|~|b|i|n|d|Shift|@|a|Shift|#|1|Shift|Tab|Shift|~|s|e|t|Shift|@|a|Shift|~|Shift|+|Shift|@|a|Shift|#|1|Shift|Tab|Tab|Meta|c|v|Shift|Tab|Enter|Shift|@|a|Enter|Enter
//starttest//
