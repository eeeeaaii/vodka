...
*/
//endgnumessage//
//testname// functions_syscalls_getpixelwidth
//startdescription//
/*
tests get-pixel-width in several ways - tests getting normal width and exploded width, tests leaving off the optional arg and verifying that it's same as normal, and tests it with both a doc and an org (to make sure to test the case where it uses a previously rendered rendernode)
*/
//enddescription//
//testspec// |Shift|~|g|e|t|-|p|i|x|e|l|-|w|i|d|t|h|Enter|Shift|)|h|e|l|l|o|Shift|Tab|Shift|!|Enter|Shift|Tab|Meta|c|v|Tab|ArrowRight|ArrowRight|Backspace|y|Enter|Shift|Tab|Shift|~|g|e|t|-|p|i|x|e|l|-|w|i|d|t|h|Shift|{|h|e|l|l|o|Shift|Tab|Tab|Tab|Shift|!|Enter|Shift|Tab|Meta|c|v|Tab|ArrowRight|ArrowRight|Backspace|Backspace|Backspace|y|Enter|Shift|Tab|ArrowUp|ArrowUp|ArrowUp|Meta|c|v|Tab|ArrowRight|ArrowRight|Shift|Backspace|Shift|Tab|ArrowRight|ArrowRight|ArrowRight|Meta|c|v|Tab|ArrowRight|ArrowRight|Backspace|Shift|Backspace|Shift|Tab|ArrowLeft|ArrowLeft|ArrowLeft|ArrowLeft|ArrowLeft|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter|ArrowRight|Enter
//starttest//
