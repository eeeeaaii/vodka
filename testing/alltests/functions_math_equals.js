...
*/
//endgnumessage//
//testname// functions_math_equals
//startdescription//
/*
test of mathematical equals, including testing for whether different types are equal (float/int)
*/
//enddescription//
//testspec// |Shift|~|=|Tab|Shift|#|3|Shift|#|3|Shift|Tab|Enter|Shift|~|=|Shift|#|3|Shift|%|3|Shift|Tab|Enter|Shift|~|=|Shift|%|3|Shift|%|3|Shift|Tab|Enter|Shift|~|=|Shift|Shift|%|3|Shift|#|4|Shift|Tab|Enter
//starttest//
