...
*/
//endgnumessage//
//testname//  execution_wrongarg
//startdescription//
/*
this test just tests the basic functioning of when you pass the wrong arg to a builtin. I do not currently have individual tests for each combination of expected/actual args.
*/
//enddescription//
//testspec// |Shift|~|s|t|r|i|n|g|-|l|e|n|g|t|h|Tab|Shift|$|Shift|Enter|h|e|l|l|o|Tab|Enter|Shift|Tab|Shift|~|s|t|r|i|n|g|-|l|e|n|g|t|h|Tab|Shift|$|Shift|Tab|ArrowUp|Shift|Enter|ArrowDown|Shift|Enter
//starttest//
