...
*/
//endgnumessage//
//testname// actions_undo_insert_nexes
//startdescription//
/*
undoes inserting objects: command, bool, symbol, integer, string, float, instantiator, lambda, deferredcommand, org, line, doc, word, wavetable
*/
//enddescription//
//testspec// |Shift|~|Enter|Shift|~|ArrowRight|Shift|!|Enter|Shift|@|#|$|Tab|Enter|Shift|%|Shift|^|Enter|ArrowRight|Shift|&|ArrowRight|Shift|*|Enter|ArrowRight|Shift|(|ArrowRight|Shift|{|ArrowRight|[|ArrowRight|Shift|<|ArrowRight|Shift|_|Meta|z|z|z|z|z|z|z|z|z|z|z|z|z|z|z|z|z|z|z|z|z|z
//starttest//
