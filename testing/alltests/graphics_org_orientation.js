...
*/
//endgnumessage//
//testname// graphics_org_orientation
//startdescription//
/*
tests all three orientations of org: h, v, and z
*/
//enddescription//
//testspec// |Shift|(|Shift|{|a|Shift|Tab|Tab|Tab|Shift|{|b|Shift|Tab|Tab|Tab|Shift|{|c|Shift|Tab|Tab|Tab|Shift|Tab|Shift|(|Shift| | |Shift|{|a|Shift|Tab|Tab|Tab|Shift|{|b|Shift|Tab|Tab|Tab|Shift|{|c|Shift|Tab|Tab|Tab|Tab|Shift|(|Shift| |Shift|{|a|Shift|Tab|Tab|Tab|Shift|{|b|Shift|Tab|Tab|Tab|Shift|{|c|Shift|Tab|Tab|Tab
//starttest//
