...
*/
//endgnumessage//
//testname// functions_async_reportasyncerror
//startdescription//
/*
report async error
*/
//enddescription//
//testspec// |b|i|n|d|Shift|@|f|o|o|Enter|Shift|&|Shift| |Shift|*|/|Enter|w|a|i|t|-|f|o|r|-|d|e|l|a|y|Enter|Shift|#|2|0|Shift|Tab|Shift|#|Shift|Tab|Shift|Alt|Tab|Shift|~|r|e|p|o|r|t|-|a|s|y|n|c|-|e|r|r|o|r|Shift| |Shift|#|Shift|Tab|Tab|Shift|Enter|f|o|o|Enter|Enter
//starttest//
...
testactions.push({type:'keydown',code:'Enter'});
testactions.push({type:'keyup',code:'Enter'});
testactions.push({type:'pause',length:100});
