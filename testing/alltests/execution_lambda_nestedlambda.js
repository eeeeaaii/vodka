...
*/
//endgnumessage//
//testname// execution_lambda_nestedlambda
//startdescription//
/*
We have had problems where lambdas nested inside lambdas sometimes end up with a cached or stale environment. This makes sure that if you create a function inside another one it gets a totally new env each time.
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|f|Shift|&|n|Backspace| |n|Enter|Shift| |Shift|~|l|e|t|Shift|@|f|2|Shift|&| |Backspace|Enter|Shift| |Shift|@|n|Shift|Tab|Tab|Shift|~|f|2|Shift|Tab|Tab|Meta|c|v|Enter|Shift|~|f|Shift|#|1|0|0|Shift|Tab|Enter|Shift|~|f|Shift|#|1|Shift|Tab|Enter
//starttest//
