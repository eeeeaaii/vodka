...
*/
//endgnumessage//
//testname// functions_environment_set_dereference
//startdescription//
/*
tests that set works with dereferencing, i.e. you are setting an inner member of a struct
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Enter|Shift|@|x|Enter|Shift|(|Shift|#|`|a|Enter|Backspace|3|2|Enter|Shift|Tab|Tab|Shift|Enter|Shift|Shift|@|x|Enter|Enter|Shift|@|x|.|a|Enter|Enter|Shift|~|s|e|t|Enter|Shift|@|x|.|a|Enter|Shift|#|1|0|0|Shift|Tab|Enter|Shift|@|x|Enter|Enter
//starttest//
