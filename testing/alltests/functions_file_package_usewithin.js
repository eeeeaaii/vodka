...
*/
//endgnumessage//
//testname// functions_file_package_usewithin
//startdescription//
/*
tests package variable scope life, i.e. if a symbol is bound within a package then it's usable without a qualifier in the package but only with a qualifier outside the package
*/
//enddescription//
//testspec// |Shift|~|p|c|Backspace|a|c|k|a|e|Backspace|g|e|Shift| |Shift|@|f|o|o|Enter|Shift|~|b|e|g|i|n|Enter|Shift| |Shift|~|b|i|n|d|Shift|@|x|Shift|#|1|0|0|Shift|Tab|Shift|~|b|i|n|d|Shift|@|f|Enter|Shift|&|Shift| |Shift|~|Shift|+|Enter|Shift|Shift|@|x|Enter|Shift|@|f|o|o|Shift|:|x|Enter|Shift|Tab|Tab|Tab|Tab|Tab|Shift|Enter|Shift|~|f|o|o|Shift|:|f|Enter|Enter|Shift|~|f|Enter|Enter
//starttest//
