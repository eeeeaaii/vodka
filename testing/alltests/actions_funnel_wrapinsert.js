...
*/
//endgnumessage//
//testname// actions_funnel_wrapinsert
//startdescription//
/*
tests the wrap-insert functionality for all object types that support it (for example, alt-shift-~)
*/
//enddescription//
//testspec// |Shift|#|Shift|Alt|`|ArrowRight|Shift|#|Shift|Alt|ﬂ|ArrowRight|Shift|#|Shift|Alt|‡|ArrowRight|Shift|#|Shift|Alt|°|ArrowRight|Shift|#|Shift|Alt|·|ArrowRight|Shift|#|Shift|Alt|”|ArrowRight|Shift|#|Alt|“|Shift|#|Shift|Alt|¯
//starttest//
