...
*/
//endgnumessage//
//testname// foreign_canvas_rect_transparent
//startdescription//
/*
tests drawing two rectangles, where the second one has some transparency and is overlaid over the first one
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Shift|~|i|n|s|t|a|n|t|i|a|t|e|Shift|@|Backspace|Backspace|Shift|^|`|Shift|X|C|a|n|v|Backspace|Backspace|Backspace|Backspace|Shift|C|Backspace|Backspace|Shift|C|a|n|v|a|s|Enter|Shift|#|2|0|0|Shift|#|2|0|0|Shift|Tab|Tab|Shift|Enter|ArrowLeft|Shift|@|a|Enter|Enter|ArrowRight|Shift|~|Shift|@|a|`|r|e|c|t|Enter|Shift|(|Shift|#|5|0|Shift|#|4|0|Shift|#|2|1|0|Shift|Tab|Shift|#|#|Shift|#|1|0|0|Shift|#|1|0|0|Shift|Tab|Shift|Enter|Shift|~|Shift|@|a|`|r|e|c|t|Enter|Shift|(|Shift|#|1|2|7|Shift|#|2|5|5|Shift|#|#|Shift|Tab|Shift|#|5|0|Shift|#|5|0|Shift|#|1|0|0|Shift|#|1|0|0|Shift|Tab|Shift|Enter
//starttest//
...
testactions.push({type:'keyup',code:'Enter'});
testactions.push({type:'keyup',code:'ShiftLeft'});
testactions.push({type:'pause',length:300});
