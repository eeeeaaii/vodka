...
*/
//endgnumessage//
//testname// actions_funnel_symbol_basic
//startdescription//
/*
test basic operation of symbol
*/
//enddescription//
//testspec// |Shift|@|a|Enter|Enter|Shift|~|b|i|n|d|Shift|@|a|Shift|$|3|4|Tab|Enter|Shift|Tab|Enter|Enter|Shift|~|b|i|n|d|Shift|@|b|Shift|@|a|Shift|Tab|Enter|Enter
//starttest//
