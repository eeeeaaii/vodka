...
*/
//endgnumessage//
//testname// functions_iteration_forloop
//startdescription//
/*
tests the for builtin by writing a whole "find max" function, except I messed up and it actually finds the min, but I'm not changing it, I just passed in negative numbers
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|f|i|n|d|m|a|x|Enter|Shift|&|l|i|s|t|Enter|Shift| |Shift|~|l|e|t|Shift|@|m|a|x|Shift|#|0|Shift|Tab|Shift|~|f|o|r|-|l|o|o|p|Enter|Shift| |Shift|&|Enter|Shift|#|Shift|Tab|Shift|&|n|Enter|Backspace|Backspace|i|Enter|Shift|~|Shift|<|Enter|Shift|@|i|Enter|Shift|~|l|i|s|t|-|l|e|n|g|t|h|Enter|Shift|@|l|i|s|t|Shift|Tab|Tab|Tab|Shift|&|i|Enter|Shift| |Shift|~|l|e|t|Shift|@|v|a|l|Shift|~|l|i|s|t|-|g|e|t|Shift|@|i|s|t|Backspace|Backspace|Backspace|l|i|s|t|Shift|@|i|Shift|Tab|Tab|Shift|~|i|f|Shift| |Shift|~|Shift|<|Shift|@|v|a|l|Shift|@|m|a|x|Enter|Shift|Tab|Shift|~|s|e|t|Enter|Shift|@|m|a|x|Shift|@|v|a|l|Shift|Tab|Shift|!|Shift|Tab|Shift| |Shift|Tab|Shift|&|i|Enter|Shift|~|Shift|+|Shift|#|Shift|Backspace|Shift|@|i|Shift|#|1|Shift|Tab|Shift|Tab|Shift|Tab|Shift|@|m|a|x|Shift|Tab|Tab|Shift|Enter|Shift|~|f|i|n|d|m|a|x|Enter|Shift|(|Shift|#|1|0|0|Shift|#|3|0|2|Shift|#|9|3|Shift|Tab|Tab|Enter|Shift|~|f|i|n|d|m|a|x|Enter|Shift|(|Shift|#|-|2|3|Enter|-|3|2|3|3|Shift|Backspace|Shift|#|-|4|3|2|4|Enter|Shift|Tab|Shift| |Shift| |Tab|Shift|#|-|9|4|Enter|Shift|Tab|Tab|Enter
//starttest//
