...
*/
//endgnumessage//
//testname// functions_tag_addtag_enforcecontract
//startdescription//
/*
tests that trying to add a tag with add-tag that violates a contract will not work
*/
//enddescription//
//testspec// |Shift|~|c|e|r|i|Backspace|t|i|f|y|Control| |Enter|Shift|@|Shift|Backspace|Shift|$|i|n|t|Tab|Enter|Shift|~|i|s|-|i|n|Control| |Backspace|Backspace|Backspace|Backspace|Backspace|t|y|p|e|Control| |Enter|Shift|#|Shift|Tab|Tab|Enter|Shift|~|a|d|d|-|t|a|g| |t|o|Enter|Shift|$|Shift|Backspace|Shift|Backspace|Tab|Enter|Shift|Backspace|Shift|$|i|n|t|Tab|Enter|Shift|$|s|t|r|i|n|g|Tab|Enter|Shift|Tab|Enter
//starttest//
