...
*/
//endgnumessage//
//testname// functions_file_using
//startdescription//
/*
test of the "using" command, with both failed and successful symbol lookups inside it.
*/
//enddescription//
//testspec// |Shift|~|p|a|c|k|a|g|e|Shift| |Shift|@|f|o|o|Shift|~|b|e|g|i|n|Shift| |Shift|~|b|i|n|d|Shift|@|b|a|r|Shift|(|h|e|l|l|o|Shift|Tab|Tab|Tab|Tab|Enter|Shift|~|u|s|i|n|g|Shift| |Shift|(|Shift|@|f|o|o|Shift|Tab|Shift|@|b|a|r|Shift|Tab|Enter|Shift|~|u|s|i|n|g|Shift| |Shift|(|Shift|@|f|o|o|Shift|Tab|Shift|@|b|a|t|Shift|Tab|Enter
//starttest//
