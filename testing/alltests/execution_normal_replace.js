...
*/
//endgnumessage//
//testname// execution_normal_replace
//startdescription//
/*
just normal test that evalutes by just pressing enter (replacing the nex), also tests error case
*/
//enddescription//
//testspec// |Shift|~|Shift|+|Shift|#|3|Shift|#|3|Shift|Tab|Enter|Shift|~|Shift|b|l|o|r|c|h|Enter
//starttest//
