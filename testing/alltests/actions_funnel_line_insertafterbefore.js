...
*/
//endgnumessage//
//testname// actions_funnel_line_insertafterbefore
//startdescription//
/*
verifies that when line is selected, line is inside command, and we are in insert-inside, and you type a symbol like #, it inserts the literal symbol as a separator inside the word. Test for all commandlike contexts, make sure to test for inserting separators or letters also
*/
//enddescription//
//testspec// |Shift|~|a|p|p|l|e|s|Enter|[|ArrowRight|a|ArrowLeft|ArrowLeft|a|ArrowRight|ArrowRight|3|ArrowLeft|ArrowLeft|3|ArrowRight|;|ArrowLeft|Alt|ArrowLeft|;|ArrowRight|Alt|ArrowRight|Shift|%|ArrowLeft|ArrowLeft|Shift|%|Enter
//starttest//
