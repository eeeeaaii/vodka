...
*/
//endgnumessage//
//testname// actions_funnel_insertionpip
//startdescription//
/*
verifies that alt-arrow moves the insertion pip before or after the selected item and that alt-shift-tab puts the insertion pip around the selected item, and that alt-tab puts it inside. The way the verification works is that a new nex of a given type for this test is inserted each time the pip is moved.
*/
//enddescription//
//testspec// |Shift|~|Enter|Shift|#|#|#|Enter|Alt|Alt|ArrowLeft|Shift|%|Shift|Tab|Shift|~|Enter|Shift|#|#|#|Enter|ArrowLeft|ArrowLeft|ArrowLeft|Alt|ArrowRight|Shift|%|Enter|Shift|Tab|Shift|~|Enter|Shift|#|#|#|Enter|Shift|Alt|Tab|Shift|&|Shift|Tab|Shift|~|Enter|Shift|#|#|#|Enter|Shift|(|ArrowRight|Alt|Tab|Shift|%
//starttest//
...
testactions.push({type:'keydown',code:'Enter'});
testactions.push({type:'keyup',code:'Enter'});
testactions.push({type:'keydown',code:'AltLeft'});
testactions.push({type:'keyup',code:'AltLeft'});
testactions.push({type:'keydown',code:'AltLeft'});
