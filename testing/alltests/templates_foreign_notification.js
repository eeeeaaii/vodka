...
*/
//endgnumessage//
//testname// templates_foreign_notification
//startdescription//
/*
basic showing of notification via foreign templates
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Shift|~|i|n|s|t|a|n|t|i|a|t|e|Shift|^|`|Shift|N|o|t|i|f|i|c|a|t|i|o|n|Enter|Shift|Tab|Tab|Enter|Shift|~|Tab|Shift|@|a|`|s|h|o|w|Enter|Shift|$|Shift|Enter|h|e|l|l|o|Tab|Enter|Shift|Tab|Enter|Shift|~|Tab|Shift|~|i|n|s|t|a|n|t|i|a|t|e|Tab|Shift|^|Shift|Enter|`|Shift|N|o|t|i|f|i|c|a|t|i|o|n|Enter|Shift|Tab|`|s|h|o|w|Enter|Shift|$|Shift|Enter|h|e|l|l|o|Tab|Enter|Shift|Tab|Enter
//starttest//
