...
*/
//endgnumessage//
//testname// functions_iteration_mapwith
//startdescription//
/*
test map with
*/
//enddescription//
//testspec// |Shift|~|m|a|p|Control| |Enter|Backspace|Enter|Shift|(|Shift|#|1|Shift|#|-|1|Shift|#|1|Shift|#|1|Backspace|2|Enter|Shift|Tab|Shift|&|n|Enter|Shift| |Shift|~|Shift|*|Enter|Shift|@|n|Shift|Enter|Shift|#|1|0|0|Shift|Tab|Tab|Tab|Enter
//starttest//
