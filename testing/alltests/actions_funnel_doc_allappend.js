...
*/
//endgnumessage//
//testname// actions_funnel_doc_allappend
//startdescription//
/*
tests that when you have a doc, line, or word selected and the insertion pip is inside, if you type a letter that letter gets appended to the last letter of the last word etc.
*/
//enddescription//
//testspec// |Shift|{|Shift|H|e|l|o|Backspace|l|o| |t|h|e|r|e| |w|o|r|l|d|Enter|h|o|w| |y|a| |d|o|i|n|g|Alt|Tab|Shift|Tab|Tab|Tab|Tab|Tab|Alt|Tab|a|Shift|Tab|Tab|a|Shift|Tab|Alt|Tab|a
//starttest//
