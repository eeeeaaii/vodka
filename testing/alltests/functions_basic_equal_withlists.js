...
*/
//endgnumessage//
//testname// functions_basic_equal_withlists
//startdescription//
/*
equal, with lists
*/
//enddescription//
//testspec// |Shift|~|e|q|u|a|l|Enter|Shift|(|Shift|#|3|Shift|#|4|Enter|Shift|(|Shift|#|3|Enter|Shift|#|5|Enter|Shift|Tab|Tab|Meta|c|v|Shift|Tab|Meta|c|v|Enter|ArrowLeft|ArrowLeft|Meta|c|ArrowRight|ArrowRight|ArrowRight|Meta|v|Tab|Tab|Meta|x|Tab|ArrowRight|Meta|v|Shift|Tab|Tab|Enter|ArrowLeft|ArrowLeft|ArrowLeft|Meta|c|ArrowRight|ArrowRight|ArrowRight|ArrowRight|Meta|v|Tab|Tab|ArrowRight|ArrowRight|ArrowRight|Meta|x|ArrowLeft|Meta|v|Shift|Tab|Tab|Enter|ArrowLeft|ArrowLeft|ArrowLeft|ArrowLeft|Meta|c|ArrowRight|ArrowRight|ArrowRight|ArrowRight|ArrowRight|Meta|v|Tab|Tab|Shift|Backspace|Shift|%|3|Enter|Shift|Tab|Shift|Tab|Enter
//starttest//
