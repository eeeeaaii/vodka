...
*/
//endgnumessage//
//testname//  saveload_docwithcontents
//startdescription//
/*
The previous doc save/load test didn't test a doc that had any text in it. There were a few bugs: letters and separators weren't being parsed correctly during load, and there was no handling of newlines - so this test covers those cases now.
*/
//enddescription//
//testspec// |Shift|~|s|a|v|e|Shift|@|t|Shift|{|Shift|H|e|l|l|o| |t|h|e|r|e|Enter|f|o|l|k|s|Shift|Tab|Tab|Tab|Tab|Shift|Enter|Shift|~|l|o|a|d|Shift|@|t|Shift|Tab|Shift|Enter
//starttest//
