...
*/
//endgnumessage//
//testname// graphics_tags_docs
//startdescription//
/*
verifies tags in all the doc types
*/
//enddescription//
//testspec// |Shift|{|a|p|p|l|e|s|Shift|Tab|`|t|a|g|Enter|Shift|Tab|`|t|a|g|Enter|Shift|~|Shift|Backspace|Shift|Tab|`|t|a|g|Enter|Tab|Tab|Tab|Tab|`|t|a|g|Enter
//starttest//
