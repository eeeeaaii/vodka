...
*/
//endgnumessage//
//testname// actions_undo_movement_closeoff
//startdescription//
/*
tests undoing the "close off" selection changes (close paren etc)
*/
//enddescription//
//testspec// |Shift|(|Shift|#|Shift|(|Shift|#|Shift|(|Shift|#|Shift|)|)|)|Meta|z|z|z|Shift|{|a|p|p|l|e|Shift|}|Meta|z|Shift|~|Enter|[|b|a|n|a|n|a|Shift|]|Meta|z|Shift|~|Shift|<|Enter|Shift|<|c|a|t|Shift|Shift|>|Meta|z|b|i|r|d
//starttest//
