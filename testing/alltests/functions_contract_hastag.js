...
*/
//endgnumessage//
//testname// functions_contract_hastag
//startdescription//
/*
tests has tag contract - note that currently once a tag has been added it doesn't get rechecked if other tags change
*/
//enddescription//
//testspec// |Shift|~|c|e|r|t|i|f|y| |s|a|t|i|s|f|i|e|s|Enter|Shift|$|a|Tab|Enter|Shift|~|h|a|s|-|t|a|g|-|c|o|n|t|r|a|c|t|Enter|Shift|$|b|Tab|Enter|Shift|Tab|Tab|Enter|Shift|#|Enter|`|a|Enter|Shift|#|Enter|`|b|Enter|`|a|Enter|Meta|c|v|`|ArrowLeft|ArrowLeft|Backspace|Enter|Meta|c|v|`|a|Enter|Meta|c|v|`|Backspace|Backspace|a|Enter
//starttest//
