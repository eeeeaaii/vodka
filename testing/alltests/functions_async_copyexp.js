...
*/
//endgnumessage//
//testname//  functions_async_copyexp
//startdescription//
/*
Tests the copy-exp builtin, which basically just makes it so you can actually use an exp literal in a function. This is not ideal really.
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|f|Shift|&|Enter|Shift| |Shift|~|s|e|t|-|d|e|l|a|y|Tab|Shift|~|m|a|k|e|Backspace|Backspace|Backspace|Backspace|c|o|p|y|-|e|x|p|Tab|Shift|*|Shift|Tab|Shift|#|1|0|0|0|Shift|Tab|Tab|Tab|Shift|Enter|Shift|~|f|ArrowRight|Shift|~|f|Enter|ArrowLeft|Enter
//starttest//
