...
*/
//endgnumessage//
//testname// actions_funnel_mutables
//startdescription//
/*
attempts to verify what mutables are actually supposed to do, under copying and not copying, aliasing to the same object, when returned by functions, etc.
*/
//enddescription//
//testspec// |Shift|#|3|3|Enter|Meta|c|v|ArrowLeft|ArrowLeft|Backspace|4|Enter|ArrowRight|ArrowRight|Enter|Backspace|Meta|c|v|Shift|~|b|i|n|d|Shift|@|a|Shift|#|3|3|Shift|Tab|Enter|Meta|c|v|Enter|ArrowLeft|ArrowLeft|Enter|ArrowRight|ArrowRight|Shift|~|b|i|n|d|Shift|@|b|Shift|&|Shift|#|Backspace|Tab|Shift|#|3|4|Shift|Tab|Tab|Shift|Enter|Shift|~|b|Enter|Enter|ArrowLeft|ArrowLeft|Tab|ArrowRight|ArrowRight|Tab|Backspace|6|Shift|Tab|Tab|Shift|Enter|ArrowRight|Shift|~|b|Enter|Enter|ArrowLeft|ArrowLeft|ArrowLeft|Tab|Tab|Tab|Tab|Enter|Shift|Tab|Tab|ArrowRight|ArrowRight|ArrowRight|Shift|~|b|Enter|Enter
//starttest//
