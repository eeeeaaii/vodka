...
*/
//endgnumessage//
//testname// template_instantiation_lexicalscope
//startdescription//
/*
verifies that when instantiating a template, inner lambdas get the correct lexical scope in their self scopes
*/
//enddescription//
//testspec// |p|a|c|k|a|g|e|Shift| |Shift|@|t|Enter|b|i|n|d|Enter|Shift|@|Shift|V|Enter|Shift|(|Shift|&|`|g|e|t|m|o|r|e|v|Enter|Shift|^|Shift|V|Enter|Shift|Tab|Shift|Tab|Shift|Tab|Shift|Tab|Shift|Enter|Shift|^|Shift|Backspace|Shift|~|.|g|e|t|m|o|r|e|v|Enter|Shift|^|t|Shift|:|Shift|V|Enter|Shift|Tab|Enter
//starttest//
