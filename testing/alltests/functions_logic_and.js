...
*/
//endgnumessage//
//testname//  functions_logic_and
//startdescription//
/*
test all 4 truth table possibilities for logical and
*/
//enddescription//
//testspec// |Shift|~|a|n|d|Tab|Shift|!|!|Shift|Tab|Shift|~|a|n|d|Tab|Shift|!|Shift|!|y|Shift|Tab|Shift|~|a|n|d|Tab|Shift|!|y|Shift|!|Shift|Tab|Shift|~|a|n|d|Shift|Tab|Shift|!|y|Shift|!|y|Shift|Tab|ArrowUp|ArrowUp|ArrowUp|Shift|Enter|ArrowDown|Shift|Enter|ArrowDown|Shift|Enter|ArrowDown|Shift|Enter
//starttest//
