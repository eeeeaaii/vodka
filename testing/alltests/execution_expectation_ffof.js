...
*/
//endgnumessage//
//testname// execution_expectation_ffof
//startdescription//
/*
tests "ff-of" by setting a function with ff-with, then extracting it again with ff-of
*/
//enddescription//
//testspec// |Shift|~|b|i|n|d|Shift|@|a|Shift|~|f|f|-|w|i|t|h|Tab|Shift|*|Tab|Shift|#|Shift|Tab|Shift|&| |a|Shift|#| |Backspace|Enter|Shift| |Shift|~|Shift|+|Shift|@|a|Shift|#|1|Shift|Tab|Tab|Tab|Tab|Enter|Enter|Shift|Alt|`|f|f|-|o|f|Enter
//starttest//
