...
*/
//endgnumessage//
//testname// saveload_error_corruptedfile
//startdescription//
/*
loads a file called unparsable-file-for-testing, will fail if that file is deleted but all you have to do to create it again is just put garbage in it
*/
//enddescription//
//testspec// |Shift|~|l|o|a|d|Shift|@|u|n|p|a|r|s|a|b|l|e|-|f|i|l|e|-|f|o|r|-|t|e|s|t|i|n|g|Shift|Tab|Enter
//starttest//
