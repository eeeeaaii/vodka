/**
 * PEG.js v0.11.0, ab0aa7f0c673a6d1ca0b
 * https://pegjs.org/
 *
...
var Grammar = function (_Node) {
  ...
  function Grammar(initializer, rules, comments, location) {
    ...
    _this.rules = rules;
    _this._alwaysConsumesOnSuccess = new AlwaysConsumesOnSuccess(_assertThisInitialized(_this));
    return _this;
  }
