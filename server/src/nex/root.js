...
class Root extends NexContainer {
	...
	getEventTable(context) {
		return {
			...
			'CtrlArrowUp': 'do-nothing',
			'CtrlArrowDown': 'do-nothing',
			'CtrlArrowLeft': 'do-nothing',
			'CtrlArrowRight': 'do-nothing',
			'AltShiftTab': 'do-nothing',
			'CtrlShiftTab': 'do-nothing',
			'ShiftEnter': 'do-nothing',
			'Enter': 'do-nothing',
			'ShiftSpace': 'do-nothing',
			'ShiftBackspace': 'do-nothing',
			'AltBackspace': 'do-nothing',
			'CtrlBackspace': 'do-nothing',
			'AltEnter': 'do-nothing',
			'Alt\\': 'do-nothing'
