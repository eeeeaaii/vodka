...
var peg$r3 = /^[^`]/;
  ...
  var peg$e2 = peg$literalExpectation("_)", false);
  ...
  var peg$e14 = peg$literalExpectation("yes", false);
  var peg$e15 = peg$literalExpectation("no", false);
...
var peg$e30 = peg$classExpectation(["`"], true, false);
  ...
  var peg$f13 = function(CHILDREN) { return CHILDREN; };
  var peg$f14 = function(INST_NAME, PRIVATE, TAGLIST) { return PF.makeInstanceAtom(INST_NAME, PRIVATE, TAGLIST); };
  var peg$f15 = function(INST_NAME_DATA) { return INST_NAME_DATA; };
  var peg$f16 = function(TAGLIST) { return PF.makeBool(true, TAGLIST); };
  var peg$f17 = function(TAGLIST) { return PF.makeBool(false, TAGLIST); };
  var peg$f18 = function(TAGLIST, SYMBOL) { return PF.makeSymbol(SYMBOL, TAGLIST); };
  var peg$f19 = function(SYMBOL_CHAR) { return SYMBOL_CHAR; };
  var peg$f20 = function() { return '_'; };
  var peg$f21 = function(TAGLIST, NEGATION, DIGITS) { return PF.makeInteger(NEGATION, DIGITS, TAGLIST); };
  var peg$f22 = function(TAGLIST, DATA) { return PF.makeString(DATA, TAGLIST); };
  var peg$f23 = function(TAGLIST, DATA) { return PF.makeError(DATA, TAGLIST); };
  var peg$f24 = function(TAGLIST, FLOAT) { return PF.makeFloat(FLOAT, TAGLIST); };
  var peg$f25 = function(TAGLIST) { return PF.makeNil(TAGLIST) };
  var peg$f26 = function(INT_PART, DEC_DIGITS) {return DEC_DIGITS; };
  var peg$f27 = function(INT_PART, DEC_PART) { return  DEC_PART ? (INT_PART + '.' + DEC_PART) : INT_PART};
  var peg$f28 = function(DEC_DIGITS) { return '0.' + DEC_DIGITS; };
  var peg$f29 = function(DIGITS) { return DIGITS.join(''); };
  var peg$f30 = function(DIGITS) { return '-' + DIGITS.join(''); };
  var peg$f31 = function(TAGS) { return TAGS; };
  var peg$f32 = function(TAG) { return TAG; };
  var peg$f33 = function(TAG_DATA) { return TAG_DATA; };
  var peg$f34 = function(DATA) { return DATA; };
  var peg$f35 = function() { return null; };
  var peg$f36 = function(CHAR) { return CHAR; };
  var peg$f37 = function() { return RIGHT_BRACE; };
