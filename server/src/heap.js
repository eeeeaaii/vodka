...
//			return false;
	...
	removeEnvReference(env) {
		if (env.references == 0) {
			throw new Error('Tried to remove an env reference when the number of references was zero.');			
		}
		env.references--;
		if (env.references == 0) {
			env.cleanUp();
	...
	addReference(obj) {
		if (obj.references == 0 && obj.wasFreed) {
			console.log('warning: an object had its references temporarily go to zero, '
	...
	removeReference(obj) {
		if (obj.references == 0) {
			throw new Error('Tried to remove a reference when the number of references was zero.');
		}
		obj.references--;
		if (obj.references == 0) {
			this.free(obj);
...
`;
	...
	sizeBool() { return 1500; } // verified in chome using heap snapshot

	sizeBuiltin() { return 1500; } // NOT VERIFIED
	sizeClosure() { return 1500; } // NOT VERIFIED
	sizeCommand() { return 1500; } // NOT VERIFIED
	sizeContract() { return 1500; } // NOT VERIFIED
	sizeDeferredCommand() { return 1500; } // NOT VERIFIED
	sizeDeferredValue() { return 1500; } // NOT VERIFIED
	sizeDoc() { return 1500; } // NOT VERIFIED
	sizeEError() { return 1500; } // NOT VERIFIED
	sizeEString() { return 1500; } // NOT VERIFIED
	sizeESymbol() { return 1500; } // NOT VERIFIED
	sizeFloat() { return 1500; } // NOT VERIFIED
	sizeInstantiator() { return 1500; } // NOT VERIFIED
	sizeInteger() { return 1500; } // NOT VERIFIED
	sizeLambda() { return 1500; } // NOT VERIFIED
	sizeLetter() { return 1500; } // NOT VERIFIED
	sizeLine() { return 1500; } // NOT VERIFIED
	sizeNil() { return 1500; } // NOT VERIFIED
	sizeOrg() { return 1500; } // NOT VERIFIED
	sizeSeparator() { return 1500; } // NOT VERIFIED
	sizeWavetable() { return 1500; } // NOT VERIFIED
	sizeWord() { return 1500; } // NOT VERIFIED
	...
	incrementalSizeString() { return 2; }
	incrementalSizeSurface() { return 4; }
	incrementalSizeWavetable() { return 8; }
